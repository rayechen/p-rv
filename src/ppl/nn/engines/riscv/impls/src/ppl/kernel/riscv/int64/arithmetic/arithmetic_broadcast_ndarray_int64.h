...
static inline void arithmetic_broadcast_lastdim_no_broadcast_ndarray_int64(
    ...
    for (; i + unroll_len < end; i += unroll_len) {
        ...
        vdata10 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 10 * 2, vl), vlev_int64xm1(src1_ + 10 * 2, vl));
        vdata11 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 11 * 2, vl), vlev_int64xm1(src1_ + 11 * 2, vl));
        vdata12 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 12 * 2, vl), vlev_int64xm1(src1_ + 12 * 2, vl));
        vdata13 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 13 * 2, vl), vlev_int64xm1(src1_ + 13 * 2, vl));
        vdata14 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 14 * 2, vl), vlev_int64xm1(src1_ + 14 * 2, vl));
        vdata15 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 15 * 2, vl), vlev_int64xm1(src1_ + 15 * 2, vl));
