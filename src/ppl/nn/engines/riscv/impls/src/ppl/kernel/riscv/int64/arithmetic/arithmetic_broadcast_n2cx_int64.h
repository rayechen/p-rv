...
static inline void arithmetic_broadcast_lastdim_no_broadcast_n2cx_int64(
    const int64_t *src0,
    const int64_t *src1,
    int64_t *dst,
    ...
    if (!c0_broadcast && !c1_broadcast) {
        for (; i + unroll_len < end * C_BLK(); i += unroll_len) {     // end ?
            ...
            vdata0  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 0  * C_BLK(), vl), vlev_int64xm1(src1_ + 0  * C_BLK(), vl));
            vdata1  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 1  * C_BLK(), vl), vlev_int64xm1(src1_ + 1  * C_BLK(), vl));
            vdata2  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 2  * C_BLK(), vl), vlev_int64xm1(src1_ + 2  * C_BLK(), vl));
            vdata3  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 3  * C_BLK(), vl), vlev_int64xm1(src1_ + 3  * C_BLK(), vl));
            vdata4  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 4  * C_BLK(), vl), vlev_int64xm1(src1_ + 4  * C_BLK(), vl));
            vdata5  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 5  * C_BLK(), vl), vlev_int64xm1(src1_ + 5  * C_BLK(), vl));
            vdata6  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 6  * C_BLK(), vl), vlev_int64xm1(src1_ + 6  * C_BLK(), vl));
            vdata7  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 7  * C_BLK(), vl), vlev_int64xm1(src1_ + 7  * C_BLK(), vl));
            vdata8  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 8  * C_BLK(), vl), vlev_int64xm1(src1_ + 8  * C_BLK(), vl));
            vdata9  = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 9  * C_BLK(), vl), vlev_int64xm1(src1_ + 9  * C_BLK(), vl));
            vdata10 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 10 * C_BLK(), vl), vlev_int64xm1(src1_ + 10 * C_BLK(), vl));
            vdata11 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 11 * C_BLK(), vl), vlev_int64xm1(src1_ + 11 * C_BLK(), vl));
            vdata12 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 12 * C_BLK(), vl), vlev_int64xm1(src1_ + 12 * C_BLK(), vl));
            vdata13 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 13 * C_BLK(), vl), vlev_int64xm1(src1_ + 13 * C_BLK(), vl));
            vdata14 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 14 * C_BLK(), vl), vlev_int64xm1(src1_ + 14 * C_BLK(), vl));
            vdata15 = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_ + 15 * C_BLK(), vl), vlev_int64xm1(src1_ + 15 * C_BLK(), vl));
        ...
        for (; i + C_BLK() < end * C_BLK(); i += C_BLK()) {
            ...
            int64xm1_t vdata;
            vdata = arithmetic_vector_kernel_int64<op>(vlev_int64xm1(src0_, vl), vlev_int64xm1(src1_, vl));     //  broadcast ?
            if (fuse_relu) {
                vsev_int64xm1(dst_, vmaxvx_int64xm1(vdata, (int64_t)0, vl), vl);
            } else {
                vsev_int64xm1(dst_, vdata, vl);
...
template <arithmetic_op_type_t op, bool fuse_relu>
static inline void arithmetic_broadcast_lastdim_src0_broadcast_n2cx_int64(
    const int64_t *src0,
    const int64_t *src1,
    int64_t *dst,
...
template <arithmetic_op_type_t op, bool fuse_relu>
static inline void arithmetic_broadcast_lastdim_src1_broadcast_n2cx_int64(
    const int64_t *src0,
    const int64_t *src1,
    int64_t *dst,
...
static ppl::common::RetCode arithmetic_broadcast_recursive_n2cx_int64(
    ...
    if (dim_idx == dim_count - 1) {
        if (src0_shape[dim_idx] == src1_shape[dim_idx]) {
            arithmetic_broadcast_lastdim_no_broadcast_n2cx_int64<op, fuse_relu>(
                src0, src1, dst, start, end, c0_broadcast, c1_broadcast);
        } else if (src0_shape[dim_idx] == 1) {
            arithmetic_broadcast_lastdim_src0_broadcast_n2cx_int64<op, fuse_relu>(
                src0, src1, dst, start, end, c0_broadcast, c1_broadcast);
        } else if (src1_shape[dim_idx] == 1) {
            arithmetic_broadcast_lastdim_src1_broadcast_n2cx_int64<op, fuse_relu>(
                src0, src1, dst, start, end, c0_broadcast, c1_broadcast);
        }
    } else {
...
template <arithmetic_op_type_t op, bool fuse_relu>
static ppl::common::RetCode arithmetic_broadcast_n2cx_int64(
    const int64_t *src0,
    const int64_t *src1,
    int64_t *dst,
    ...
    const bool c0_broadcast = padded_src0_shape[c_dim_dix] != padded_src1_shape[c_dim_dix] &&
                              padded_src0_shape[c_dim_dix] == 1;
    const bool c1_broadcast = padded_src0_shape[c_dim_dix] != padded_src1_shape[c_dim_dix] &&
                              padded_src1_shape[c_dim_dix] == 1;
