...
static void maxpool2d_n8chw_1x16_kernel_fp16(
    ...
    if (w_len >= 1)  vfmax0  = vfmvvf_float16xm1(-__FLT_MAX__, vl);
    ...
    for (int64_t ih = ih_start_valid; ih < ih_end_valid; ih++) {
        for (int64_t iw = iw_start_valid; iw < iw_end_valid; iw++) {
            ...
            if (w_len >= 1)  vfmax0  = vfmaxvv_float16xm1(vfmax0 , vlev_float16xm1(src_p + 0  * stride_w * 8, vl), vl);
            if (w_len >= 2)  vfmax1  = vfmaxvv_float16xm1(vfmax1 , vlev_float16xm1(src_p + 1  * stride_w * 8, vl), vl);
            if (w_len >= 3)  vfmax2  = vfmaxvv_float16xm1(vfmax2 , vlev_float16xm1(src_p + 2  * stride_w * 8, vl), vl);
            if (w_len >= 4)  vfmax3  = vfmaxvv_float16xm1(vfmax3 , vlev_float16xm1(src_p + 3  * stride_w * 8, vl), vl);
            if (w_len >= 5)  vfmax4  = vfmaxvv_float16xm1(vfmax4 , vlev_float16xm1(src_p + 4  * stride_w * 8, vl), vl);
            if (w_len >= 6)  vfmax5  = vfmaxvv_float16xm1(vfmax5 , vlev_float16xm1(src_p + 5  * stride_w * 8, vl), vl);
            if (w_len >= 7)  vfmax6  = vfmaxvv_float16xm1(vfmax6 , vlev_float16xm1(src_p + 6  * stride_w * 8, vl), vl);
            if (w_len >= 8)  vfmax7  = vfmaxvv_float16xm1(vfmax7 , vlev_float16xm1(src_p + 7  * stride_w * 8, vl), vl);
            if (w_len >= 9)  vfmax8  = vfmaxvv_float16xm1(vfmax8 , vlev_float16xm1(src_p + 8  * stride_w * 8, vl), vl);
            if (w_len >= 10) vfmax9  = vfmaxvv_float16xm1(vfmax9 , vlev_float16xm1(src_p + 9  * stride_w * 8, vl), vl);
            if (w_len >= 11) vfmax10 = vfmaxvv_float16xm1(vfmax10, vlev_float16xm1(src_p + 10 * stride_w * 8, vl), vl);
            if (w_len >= 12) vfmax11 = vfmaxvv_float16xm1(vfmax11, vlev_float16xm1(src_p + 11 * stride_w * 8, vl), vl);
            if (w_len >= 13) vfmax12 = vfmaxvv_float16xm1(vfmax12, vlev_float16xm1(src_p + 12 * stride_w * 8, vl), vl);
            if (w_len >= 14) vfmax13 = vfmaxvv_float16xm1(vfmax13, vlev_float16xm1(src_p + 13 * stride_w * 8, vl), vl);
            if (w_len >= 15) vfmax14 = vfmaxvv_float16xm1(vfmax14, vlev_float16xm1(src_p + 14 * stride_w * 8, vl), vl);
            if (w_len >= 16) vfmax15 = vfmaxvv_float16xm1(vfmax15, vlev_float16xm1(src_p + 15 * stride_w * 8, vl), vl);
        }
    }

    __fp16 *dst_p = dst + (oh * dst_w + ow) * 8;
    if (w_len >= 1)  vsev_float16xm1(dst_p + 0  * 8, vfmax0 , vl); 
    if (w_len >= 2)  vsev_float16xm1(dst_p + 1  * 8, vfmax1 , vl);
    if (w_len >= 3)  vsev_float16xm1(dst_p + 2  * 8, vfmax2 , vl);
    if (w_len >= 4)  vsev_float16xm1(dst_p + 3  * 8, vfmax3 , vl);
    if (w_len >= 5)  vsev_float16xm1(dst_p + 4  * 8, vfmax4 , vl);
    if (w_len >= 6)  vsev_float16xm1(dst_p + 5  * 8, vfmax5 , vl);
    if (w_len >= 7)  vsev_float16xm1(dst_p + 6  * 8, vfmax6 , vl);
    if (w_len >= 8)  vsev_float16xm1(dst_p + 7  * 8, vfmax7 , vl);
    if (w_len >= 9)  vsev_float16xm1(dst_p + 8  * 8, vfmax8 , vl);
    if (w_len >= 10) vsev_float16xm1(dst_p + 9  * 8, vfmax9 , vl);
    if (w_len >= 11) vsev_float16xm1(dst_p + 10 * 8, vfmax10, vl);
    if (w_len >= 12) vsev_float16xm1(dst_p + 11 * 8, vfmax11, vl);
    if (w_len >= 13) vsev_float16xm1(dst_p + 12 * 8, vfmax12, vl);
    if (w_len >= 14) vsev_float16xm1(dst_p + 13 * 8, vfmax13, vl);
    if (w_len >= 15) vsev_float16xm1(dst_p + 14 * 8, vfmax14, vl);
    if (w_len >= 16) vsev_float16xm1(dst_p + 15 * 8, vfmax15, vl);            
}
