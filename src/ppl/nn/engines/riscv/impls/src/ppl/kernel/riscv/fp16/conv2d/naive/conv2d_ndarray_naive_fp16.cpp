...
static size_t ppl3_conv_naive_cto8c_get_cvt_filter_size_fp16(
    int64_t flt_h,
    int64_t flt_w,
    int64_t channels,
    int64_t group,
...
static void ppl3_conv_naive_cto8c_cvt_filter_fp16(
    const __fp16 *filter,
    int64_t flt_h,
    int64_t flt_w,
    int64_t num_outs,
...
static size_t ppl3_conv_naive_cto8c_get_temp_buffer_size_fp16(
    int64_t src_h,
    int64_t src_w,
    int64_t padding_h,
    int64_t padding_w,
...
static void ppl3_conv_naive_padding_src_cvt_fp16 (
    int64_t src_h,
    int64_t src_w,
    int64_t pad_h,
    int64_t pad_w,
...
static void ppl3_conv_naive_cto8c_dst_cvt_fp16 (
    int64_t dst_h,
    int64_t dst_w,
    int64_t num_outs,
    __fp16* dst,
...
static void ppl3_conv_naive_kernel_riscv_fp16(
    const __fp16 *src,
    int64_t src_h,
    int64_t src_w,
    int64_t dst_h,
...
static void ppl3_conv_naive_cto8c_general_riscv_fp16(
    const __fp16 *src,
    int64_t src_h,
    int64_t src_w,
    int64_t padding_h,
    ...
    bool reflect_pad)
{
    ...
    for (int64_t b = 0; b < batch; b++) {
        ...
        for (int64_t g = 0; g < group; g++) {
            ...
            ppl3_conv_naive_padding_src_cvt_fp16(src_h, src_w, padding_h, padding_w, channels_per_group, src_per_group, temp_src);
            ppl3_conv_naive_kernel_riscv_fp16(
                temp_src,
                src_pad_h,
                src_pad_w,
                dst_h,
        ...
        ppl3_conv_naive_cto8c_dst_cvt_fp16(dst_h, dst_w, num_outs, temp_dst, dst_per_batch);
    }
}
...
uint64_t conv2d_ndarray_naive_fp16_runtime_executor::cal_temp_buffer_size() {
    ...
    size_t temp_buffer_size = ppl3_conv_naive_cto8c_get_temp_buffer_size_fp16(
...
ppl::common::RetCode conv2d_ndarray_naive_fp16_runtime_executor::execute() {
    ...
    ppl3_conv_naive_cto8c_general_riscv_fp16(
        src_,
        src_shape_->GetDim(2),  // src_h
        src_shape_->GetDim(3),  // src_w
        conv_param_->pad_h,
...
ppl::common::RetCode conv2d_ndarray_naive_fp16_offline_manager::pick_best_tunning_param(const __fp16 *src, const __fp16 *filter, __fp16 *dst,
                                                                                        ppl::nn::TensorShape &src_shape, ppl::nn::TensorShape &dst_shape) {
    return ppl::common::RC_SUCCESS;
}

ppl::common::RetCode conv2d_ndarray_naive_fp16_offline_manager::gen_cvt_weights(const __fp16 *filter, const __fp16 *bias) {
...
LOG(INFO) << "ndarray naive conv: gen cvt weights";
    ...
    {
        cvt_filter_size_ = ppl3_conv_naive_cto8c_get_cvt_filter_size_fp16(
            kernel_h,
            kernel_w,
            channels,
            num_group,
        ...
        ppl3_conv_naive_cto8c_cvt_filter_fp16(
            filter,
            kernel_h,
            kernel_w,
            num_output,
