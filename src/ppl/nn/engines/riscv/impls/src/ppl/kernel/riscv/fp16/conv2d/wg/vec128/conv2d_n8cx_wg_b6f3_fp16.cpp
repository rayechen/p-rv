...
inline void wg_b6f3s1_src_trans_kernel(
    ...
    asm volatile(
        ...
        :"memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
         "v11", "v12", "v13", "v14", "v15", "v24", "v25", "v26", "v30", "v31",
         "t0", "t1", "t2", "t3", "t4", "f0", "f1", "f2", "f3", "f4", "f5", "f6", "f7",
         "s2", "s3", "s4"                             
    );
}
...
inline void wg_b6f3s1_dst_trans_kernel(
    ...
    asm volatile(
        ...
        :[src]"r"(dst_trans), [dst]"r"(dst), [mat]"r"(trans_mat), [tmp]"r"(tmp), [bias]"r"(bias),
         ...
         [src_ofst1]"r"(dst_trans_wg_tile_stride*2),
         [h_ofst]"r"(dst_h_offset), [w_ofst]"r"(dst_w_offset),
         [dst_h]"r"(dst_trans_h), [dst_w]"r"(dst_trans_w)
        :"memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
         "v11", "v12", "v13", "v16", "v17", "v18", "v19", "v20", "v21", "v24",
...
ppl::common::RetCode conv2d_n8cx_wg_b6f3_fp16_runtime_executor::execute() {
    ...
    const __fp16 trans_mat_dst_[10] = {
        32.0f, 0.0f, 16.0f, 0.0f, 8.0f, 0.0f,
        4.0f, 0.0f, 2.0f, 0.0f
    };
    ...
    ppl3_conv_shell_riscv_fp16<
        ...
        8,
        ppl3_get_real_filter_size<6, 3>,
        ppl3_conv_wg_bxfxs1_riscv_per_group_fp16<6, 3, wg_b6f3s1_src_trans_kernel, wg_b6f3s1_dst_trans_kernel>>
    (
        src_,
        cvt_filter_,
        cvt_bias_,
