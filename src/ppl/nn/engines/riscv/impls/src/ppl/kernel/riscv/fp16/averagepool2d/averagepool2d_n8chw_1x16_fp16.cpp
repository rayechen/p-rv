...
static void averagepool2d_n8chw_1x16_kernel_fp16(
    ...
    int64_t iw = iw_start_valid;
    {
        ...
        if (w_len >= 1)  vfave0  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 0  * stride_w * 8, vl), vl);
        if (w_len >= 2)  vfave1  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 1  * stride_w * 8, vl), vl);
        if (w_len >= 3)  vfave2  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 2  * stride_w * 8, vl), vl);
        if (w_len >= 4)  vfave3  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 3  * stride_w * 8, vl), vl);
        if (w_len >= 5)  vfave4  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 4  * stride_w * 8, vl), vl);
        if (w_len >= 6)  vfave5  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 5  * stride_w * 8, vl), vl);
        if (w_len >= 7)  vfave6  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 6  * stride_w * 8, vl), vl);
        if (w_len >= 8)  vfave7  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 7  * stride_w * 8, vl), vl);
        if (w_len >= 9)  vfave8  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 8  * stride_w * 8, vl), vl);
        if (w_len >= 10) vfave9  = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 9  * stride_w * 8, vl), vl);
        if (w_len >= 11) vfave10 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 10 * stride_w * 8, vl), vl);
        if (w_len >= 12) vfave11 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 11 * stride_w * 8, vl), vl);
        if (w_len >= 13) vfave12 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 12 * stride_w * 8, vl), vl);
        if (w_len >= 14) vfave13 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 13 * stride_w * 8, vl), vl);
        if (w_len >= 15) vfave14 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 14 * stride_w * 8, vl), vl);
        if (w_len >= 16) vfave15 = vfaddvv_float16xm1(vfzero, vlev_float16xm1(src_p + 15 * stride_w * 8, vl), vl);

        iw += 1;
    }
    for (; iw < iw_end_valid; iw++) {
        const __fp16 *src_p = src + (ih * src_w + iw) * 8;
        if (w_len >= 1)  vfave0  = vfaddvv_float16xm1(vfave0 , vlev_float16xm1(src_p + 0  * stride_w * 8, vl), vl);
        if (w_len >= 2)  vfave1  = vfaddvv_float16xm1(vfave1 , vlev_float16xm1(src_p + 1  * stride_w * 8, vl), vl);
        if (w_len >= 3)  vfave2  = vfaddvv_float16xm1(vfave2 , vlev_float16xm1(src_p + 2  * stride_w * 8, vl), vl);
        if (w_len >= 4)  vfave3  = vfaddvv_float16xm1(vfave3 , vlev_float16xm1(src_p + 3  * stride_w * 8, vl), vl);
        if (w_len >= 5)  vfave4  = vfaddvv_float16xm1(vfave4 , vlev_float16xm1(src_p + 4  * stride_w * 8, vl), vl);
        if (w_len >= 6)  vfave5  = vfaddvv_float16xm1(vfave5 , vlev_float16xm1(src_p + 5  * stride_w * 8, vl), vl);
        if (w_len >= 7)  vfave6  = vfaddvv_float16xm1(vfave6 , vlev_float16xm1(src_p + 6  * stride_w * 8, vl), vl);
        if (w_len >= 8)  vfave7  = vfaddvv_float16xm1(vfave7 , vlev_float16xm1(src_p + 7  * stride_w * 8, vl), vl);
        if (w_len >= 9)  vfave8  = vfaddvv_float16xm1(vfave8 , vlev_float16xm1(src_p + 8  * stride_w * 8, vl), vl);
        if (w_len >= 10) vfave9  = vfaddvv_float16xm1(vfave9 , vlev_float16xm1(src_p + 9  * stride_w * 8, vl), vl);
        if (w_len >= 11) vfave10 = vfaddvv_float16xm1(vfave10, vlev_float16xm1(src_p + 10 * stride_w * 8, vl), vl);
        if (w_len >= 12) vfave11 = vfaddvv_float16xm1(vfave11, vlev_float16xm1(src_p + 11 * stride_w * 8, vl), vl);
        if (w_len >= 13) vfave12 = vfaddvv_float16xm1(vfave12, vlev_float16xm1(src_p + 12 * stride_w * 8, vl), vl);
        if (w_len >= 14) vfave13 = vfaddvv_float16xm1(vfave13, vlev_float16xm1(src_p + 13 * stride_w * 8, vl), vl);
        if (w_len >= 15) vfave14 = vfaddvv_float16xm1(vfave14, vlev_float16xm1(src_p + 14 * stride_w * 8, vl), vl);
        if (w_len >= 16) vfave15 = vfaddvv_float16xm1(vfave15, vlev_float16xm1(src_p + 15 * stride_w * 8, vl), vl);
    }
    ih += 1;
    ...
    if (w_len >= 1)  vsev_float16xm1(dst_p + 0  * 8, vfmulvf_float16xm1(vfave0 , ave_divider, vl), vl); 
    if (w_len >= 2)  vsev_float16xm1(dst_p + 1  * 8, vfmulvf_float16xm1(vfave1 , ave_divider, vl), vl);
    if (w_len >= 3)  vsev_float16xm1(dst_p + 2  * 8, vfmulvf_float16xm1(vfave2 , ave_divider, vl), vl);
    if (w_len >= 4)  vsev_float16xm1(dst_p + 3  * 8, vfmulvf_float16xm1(vfave3 , ave_divider, vl), vl);
    if (w_len >= 5)  vsev_float16xm1(dst_p + 4  * 8, vfmulvf_float16xm1(vfave4 , ave_divider, vl), vl);
    if (w_len >= 6)  vsev_float16xm1(dst_p + 5  * 8, vfmulvf_float16xm1(vfave5 , ave_divider, vl), vl);
    if (w_len >= 7)  vsev_float16xm1(dst_p + 6  * 8, vfmulvf_float16xm1(vfave6 , ave_divider, vl), vl);
    if (w_len >= 8)  vsev_float16xm1(dst_p + 7  * 8, vfmulvf_float16xm1(vfave7 , ave_divider, vl), vl);
    if (w_len >= 9)  vsev_float16xm1(dst_p + 8  * 8, vfmulvf_float16xm1(vfave8 , ave_divider, vl), vl);
    if (w_len >= 10) vsev_float16xm1(dst_p + 9  * 8, vfmulvf_float16xm1(vfave9 , ave_divider, vl), vl);
    if (w_len >= 11) vsev_float16xm1(dst_p + 10 * 8, vfmulvf_float16xm1(vfave10, ave_divider, vl), vl);
    if (w_len >= 12) vsev_float16xm1(dst_p + 11 * 8, vfmulvf_float16xm1(vfave11, ave_divider, vl), vl);
    if (w_len >= 13) vsev_float16xm1(dst_p + 12 * 8, vfmulvf_float16xm1(vfave12, ave_divider, vl), vl);
    if (w_len >= 14) vsev_float16xm1(dst_p + 13 * 8, vfmulvf_float16xm1(vfave13, ave_divider, vl), vl);
    if (w_len >= 15) vsev_float16xm1(dst_p + 14 * 8, vfmulvf_float16xm1(vfave14, ave_divider, vl), vl);
    if (w_len >= 16) vsev_float16xm1(dst_p + 15 * 8, vfmulvf_float16xm1(vfave15, ave_divider, vl), vl);    
}
