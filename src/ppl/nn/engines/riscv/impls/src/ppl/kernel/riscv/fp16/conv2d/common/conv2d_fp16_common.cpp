...
conv2d_common_algo_info conv2d_fp16_algo_selector::select_algo(const ppl::nn::TensorShape& input_shape, const conv2d_common_param &param)
{

        // if (src_format == ppl::common::DATAFORMAT_NDARRAY) {
        //     auto direct_ndarray_mgr = new conv2d_n16cx_direct_ndarray_fp16_fma_manager(param, nullptr);
        //     bool supported          = direct_ndarray_mgr->is_supported();
        //     delete direct_ndarray_mgr;
        //     if (supported) {
        //         return {
        //             conv2d_common_algo::direct,
...
conv2d_offline_manager<__fp16> *conv2d_fp16_algo_selector::gen_algo(const conv2d_common_param &param, const conv2d_common_algo_info &algo_info, ppl::common::Allocator *allocator)
{
